...
export class HomeComponent implements OnInit {
  ...
  locationStatus: 'loading' | 'loaded' | 'error' | 'start' = 'start'
  forecastStatus: 'loading' | 'loaded' | 'error' | 'start' = 'start'
  ngOnInit(): void {
    this.fetchCities()
  ...
  fetchGeoLocation() {
    ...
    this.dataSvc.getUserLocation().then((v: any) => {
      this.locationStatus = 'loaded'
      this.getForeCast(v.latitude, v.longitude, true)
    }).catch(v => this.locationStatus = 'error')
  }
